...
player1 = Player("", 0.0, 0.0, 0, "", "", "", False)
player2 = Player("", 0.0, 0.0, 0, "", "", "", False)
player3 = Player("", 0.0, 0.0, 0, "", "", "", False)
player4 = Player("", 0.0, 0.0, 0, "", "", "", False)
player5 = Player("", 0.0, 0.0, 0, "", "", "", False)
player6 = Player("", 0.0, 0.0, 0, "", "", "", False)
player7 = Player("", 0.0, 0.0, 0, "", "", "", False)
player8 = Player("", 0.0, 0.0, 0, "", "", "", False)
...
def print_players_starting_info():
    ...
    global player7
    global player8
    print(str(player1.seat) + " " + player1.name + " " + str(player1.stack) + " " + player1.card1 + " " + player1.card2)
    print(str(player2.seat) + " " + player2.name + " " + str(player2.stack) + " " + player2.card1 + " " + player2.card2)
    print(str(player3.seat) + " " + player3.name + " " + str(player3.stack) + " " + player3.card1 + " " + player3.card2)
    print(str(player4.seat) + " " + player4.name + " " + str(player4.stack) + " " + player4.card1 + " " + player4.card2)
    print(str(player5.seat) + " " + player5.name + " " + str(player5.stack) + " " + player5.card1 + " " + player5.card2)
    print(str(player6.seat) + " " + player6.name + " " + str(player6.stack) + " " + player6.card1 + " " + player6.card2)
